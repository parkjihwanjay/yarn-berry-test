...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState(JSON.parse('{\
    ...
    "dependencyTreeRoots": [\
      ...
      {\
        "name": "contract",\
        "reference": "workspace:projects/contract"\
      }\
    ],\
    "enableTopLevelFallback": true,\
    "ignorePatternData": "(^(?:\\\\.yarn\\\\/sdks(?:\\\\/(?!\\\\.{1,2}(?:\\\\/|$))(?:(?:(?!(?:^|\\\\/)\\\\.{1,2}(?:\\\\/|$)).)*?)|$))$)",\
    "fallbackExclusionList": [\
      ["client", ["workspace:projects/client"]],\
      ["contract", ["workspace:projects/contract"]],\
    ...
    "packageRegistryData": [\
      ...
      ["contract", [\
        ["workspace:projects/contract", {\
          "packageLocation": "./projects/contract/",\
          "packageDependencies": [\
            ["contract", "workspace:projects/contract"],\
            ["ethers", "npm:5.6.9"]\
          ],\
